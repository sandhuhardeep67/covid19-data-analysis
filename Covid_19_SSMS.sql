...
------  Optimizing the CovidDeaths table by converting blank entries and 'NULL' strings to actual NULL values,
------  ensuring a cleaner and more accurate dataset.
...
------ Optimizing the CovidVaccinations table by converting blank entries and 'NULL' strings to actual NULL values,
------ ensuring a cleaner and more accurate dataset.
...
-------The percentage of total deaths occurred in relation to the total number of COVID-19 cases reported on a given day. ----------
...
------ An analysis of COVID-19 cases by country since the start of the pandemic,
------ highlighting the percentage of each country's population that has been infected.
...
------ An analysis of countries by COVID-19 death count relative to their total population.------------
...
------------ The worldwide percentage of deaths attributed to COVID-19 ---------
...
--------- Creating a view that showcases the average median age of individuals affected by COVID-19 across different locations.------------
...
-- I have analyzed the Stringency Index to determine its correlation with the total number of COVID-19 cases.
-- This analysis helped me understand whether stricter government policies had a positive impact on controlling the rise in COVID-19 cases.
...
--- Calculated the total vaccinations per location using a rolling period approach to provide a comprehensive view of vaccination progress over time.
...
---- Using a Common Table Expression (CTE) to calculate the percentage of the population vaccinated within a rolling period for each location,
...
--------  Utilized a temporary table to calculate the percentage of the population vaccinated within a rolling period,
--------  providing a detailed view of vaccination trends by location.
...
------- Creating a view using a temporary table to display the percentage of the population that has been vaccinated so far.
